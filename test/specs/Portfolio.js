...
// The following features need E2E testing:
// Edited version
// Login
//  Pos UC:
//      Test all accepted user / PW options
// Neg UC:
//      Test the following INVALID user / PW options
//          Typos, ADMIN, SERVER, TEST
//          Confirm that system does not inform you of a valid usere but invalid PW
// - Checkout
//      Verify that the user CAN checkout when there is product in the cart
//      Verify that the user can NOT be taken to the checkout screen if there is no product in the cart

// Checkout page
// - Verify Page Details
//     Product:
//      Confirm that Images, Prices, and descriptions match the intended values
//     Buttons, Icons, Et cetera:
//      Confirm that all Non Product Visual data matches intended values
// - Fill in delivery address
//      Verify Min / Max characters accepted
//      Verify if Special characters are accepted in the name fields
//      Verify that only numbers are accepted in the zip code field
// - Confirm checkout
//  Verify functionality of both Cancel and Finish buttons while on the Checkout Overview Page
//      Verify that a successful order displays the proper thank you message
//          Verify that the back home button on this page functions as intended
// Logout
//  Verify Logout funtionality

// About tab not in scope of tests
// Individual product pages not in scope of tests
// - Update quantity
//      Verify a User can change the quantity of items in the cart at the Your cart Page
//      Webpage does not support ability to change quanitity
// - Remove product from cart
//      Verify users can remove items from their cart from the Your cart page by"
//          Setting number of product to "0"
//              Webpage does not support ability to change quanitity
...
describe("Portfolio Test Suite: Remove items from cart.", () => {
...
describe("Portfolio Test Suite: Empty cart navigation.", () => {
...
describe("Portfolio Test Suite: Verify Cart Page.", () => {
  it("Shoud allow the user to navigate to their cart when full.", async () => {
    (await $(`//*[@id="shopping_cart_container"]/a`)).click();
    await expect(browser).toHaveUrl("https://www.saucedemo.com/cart.html");
  });
});
describe("Portfoilio Test Suite: Verify Cart page: Backpack .", () => {
  it("Should verify that the header / link displays properly.", async () => {
...
describe("Portfoilio Test Suite: Verify Cart page: Bike Light.", () => {
  it("Should verify that the header/link displays properly.", async () => {
...
describe("Portfoilio Test Suite: Verify Cart page: Bolt T-Shirt.", () => {
  it("Should display the header / link for the Bolt t-shirt.", async () => {
...
describe("Portfoilio Test Suite: Verify Cart page: Fleece Jacket.", () => {
  it("Should display the header / link for the Fleece Jacket.", async () => {
...
describe("Portfoilio Test Suite: Verify Cart page: Onesie.", () => {
  it("Should display the header / link for the Onesie.", async () => {
...
describe("Portfoilio Test Suite: Verify Cart page: red T-Shirt.", () => {
  it("Should display the header / link for the red t-shirt.", async () => {
...
describe("Portfolio Test Suite: Cart Page Remove product: backpack.", () => {
...
describe("Portfolio Test Suite: Cart Page Remove product: bike light.", () => {
...
describe("Portfolio Test Suite: Cart Page Remove product: bolt t-shirt.", () => {
...
describe("Portfolio Test Suite: Cart Page Remove product: fleece jacket.", () => {
...
describe("Portfolio Test Suite: Cart Page Remove product: Onesie.", () => {
...
describe("Portfolio Test Suite: Cart Page Remove product: Red Shirt.", () => {
...
describe("Portfolio Test Suite: Checkout Page: Empty cart checkout.", () => {
  it("Should verify that the checkout button doesn't show in an empty cart.", async () => {
    await expect();
    await (await $(`//*[@id="checkout"]`)).not.toExist();
  });
});
describe("Portfolio Test Suite: Checkout Page: Full cart checkout.", () => {
  it("Should allow the backpack to be added to cart", async () => {
    (await $(`//*[@id="add-to-cart-sauce-labs-backpack"]`)).click();
    const backpackRemove = $(`//*[@id="remove-sauce-labs-backpack"]`);
    await browser.pause(1000);
...
// "Missing tests: Checkout cancel, image verifcations, input validation (checkout)"

// Full List
// Removed image checks due to time constraints
//  Unsure of how to check images. Xpaths do not change when images are wrong.
// https://www.saucedemo.com/
// The following features need E2E testing:
// Edited version
// Login
...
//      Confirm that all Non Product Visual data matches intended values
// - Sort products
//      Confirm all 4 sort methods can be clicked AND work as xdescribed
// - Add product to cart
//      Verify all six (6) products can be added to a users cart
// - Remove product from cart
//      //      Verify all six (6) products can be removed from a users cart
...
//     Buttons, Icons, Et cetera:
//      Confirm that all Non Product Visual data matches intended values
//      Verify the Users cart can be accessed in the following scenarios:
